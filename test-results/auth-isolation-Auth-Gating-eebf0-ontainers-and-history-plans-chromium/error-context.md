...
- Name: auth-isolation.spec.ts >> Auth Gating, User Isolation, and Admin Panel >> ensures strict data isolation for custom containers and history plans
- Location: e2e\auth-isolation.spec.ts:34:3
