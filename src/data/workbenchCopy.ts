...
export const workbenchCopy = {
  en: {
    ...
    templateSelectionTitle: 'Choose an import template',
    templateSelectionEmpty: 'No import templates yet',
    templateSelectionBack: 'Back to template selection',
    templateUseWithout: 'Continue without a template',
    templateUpdateExplicit: 'Update template',
    templateSaveAs: 'Save as template',
    templateSaveAsName: 'New template name',
    templateNameRequired: 'Enter a template name',
    templateNameUnchanged: 'Save as requires a different unique name',
  ...
  zh: {
    ...
    templateLabel: '导入模板',
    templateNone: '不使用模板',
    templateSelectionTitle: '选择导入模板',
    templateSelectionEmpty: '暂无导入模板',
    templateSelectionBack: '返回模板选择',
    templateUseWithout: '不使用模板',
    templateUpdateExplicit: '更新模板',
    templateSaveAs: '另存为模板',
    templateSaveAsName: '新模板名称',
    templateNameRequired: '请输入模板名称',
    templateNameUnchanged: '另存为必须使用不同且唯一的新名称',
    templateNameDuplicate: '模板名称已存在',
    templateConfigInvalid: '模板配置不完整或存在映射冲突',
    ...
    mappingDuplicateConflict: '列“{column}”同时映射到{fields}',
