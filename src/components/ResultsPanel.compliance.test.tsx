...
function props(planCompliance: ActivePlanCompliance, locale: ResultsPanelProps['locale'] = 'en'): ResultsPanelProps {
  return {
    ...
    loadingSteps: {
      ...
      activeLoadingGroupIndex: 0,
      loadingGroupsPlaying: false,
      setActiveLoadingGroupIndex: fn,
      setLoadingGroupsPlaying: fn,
    },
    cog: {
      cogResult: { cog: { x: 0, y: 0, z: 0 }, center: { x: 0, y: 0, z: 0 }, offset: { x: 0, y: 0, z: 0 }, totalWeight: 0, warning: false, balanced: true },
      showCogOverlay: false,
      vehicleProfile: 'container-only',
      toggleCogOverlay: fn,
      setVehicleProfile: fn,
    },
    compare: {
      compareCandidates: [],
      compareSelection: [],
      setCompareSelection: fn,
      selectContainerById: fn,
    },
    fill: {
      fillSuggestions: [],
      handleAddFillCargo: fn,
      handleAddAllFillCargo: fn,
    },
    exportActions: {
      exportTemplates: [],
      exportTemplateLoadFailed: false,
      selectedExportTemplateId: '',
      setSelectedExportTemplateId: fn,
      fetchExportTemplates: fn,
      importMessages: [],
      reviewChecklist: { items: [], summary: { total: 0, errorCount: 0, warningCount: 0 } },
      exportReviewChecklistJson: fn,
      exportReviewChecklistExcel: fn,
      importExcel: fn,
      downloadImportTemplate: fn,
      exportExcel: fn,
      saveCurrentPlan: fn,
      exportPlaybackInstructions: fn,
      exportLoadingSheet: fn,
    },
    selection: {
      activeSelectedBoxId: null,
      selectManualBox: fn,
      setSelectedBoxId: fn,
    },
  }
