...
const issueMessages: Record<Locale, Record<ManualOperationNotice['reasonCode'], string>> = {
  en: {
    ...
    stacking: 'Operation rejected: the box exceeds stack capacity limits.',
    'max-stack-layers': 'Operation rejected: the box exceeds stack capacity limits.',
    'ground-only': 'Operation rejected: this cargo is limited to floor placement.',
    overweight: 'Operation rejected: total cargo weight exceeds container maximum.',
  ...
  zh: {
    ...
    stacking: '操作未生效：货物超过堆叠容量限制。',
    'max-stack-layers': '操作未生效：货物超过堆叠容量限制。',
    'ground-only': '操作未生效：该货物仅限地面放置。',
    overweight: '操作未生效：货物总重量超过货柜最大承载。',
