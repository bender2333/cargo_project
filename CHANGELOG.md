...
- Remaining for full 2026-06-07 plan closure: rerun the full local verification ladder after the performance documentation update, then deploy and run remote E2E.
